...
class BankingClassifier:
    ...
    def perform_eda(self):
        ...
        plt.close()
        logging.info(f"EDA plots saved to {self.plots_dir}")

    def preprocess_and_balance_data(self):
        logging.info("Preprocessing and balancing data...")
        ...
        logging.info("Data preprocessing and balancing complete.")
    ...
    def save_artifacts(self):
        logging.info("Saving models and preprocessing artifacts...")
        for name, model in self.models.items():
        ...
        logging.info(f"Artifacts saved to {self.models_dir}")
    ...
    def predict_on_new_data(self, new_data):
        ...
        logging.info(f"Best Model ({best_model_name}) Prediction: {prediction[0]}")
        logging.info(f"Prediction Probabilities: {prediction_proba[0]}")
